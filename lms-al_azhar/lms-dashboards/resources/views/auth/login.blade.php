<x-guest-layout>
        ...
        <div class="uni-container" style="font-family: 'Plus Jakarta Sans', sans-serif; height: 100vh; display: flex; align-items: center;">
            ...
            <div class="uni-right" style="flex: 0.8; display: flex; align-items: center; justify-content: flex-start; padding-left: 80px; z-index: 5;">
                <div style="width: 100%; max-width: 350px; display: flex; flex-direction: column;">
                    ...
                    @if (session('status'))
                        <div class="uni-status-text" style="color: #10b981; font-size: 12px; margin-bottom: 12px; text-align: center; font-weight: 500;">
                            {{ session('status') }}
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div style="position: relative; margin-bottom: 20px;">
                            <label style="position: absolute; left: 14px; top: -9px; background: #ffffff; padding: 0 6px; font-size: 11px; font-weight: 600; color: #FF7A60; z-index: 2;">Email</label>
                            <input type="email" name="email" value="{{ old('email') }}" required autofocus style="width: 100%; padding: 13px 40px 13px 16px; border: 1.5px solid #FF7A60; border-radius: 10px; font-size: 14px; outline: none; color: #1e293b; background: #ffffff; font-family: inherit; box-shadow: 0 0 0 3px rgba(255, 122, 96, 0.04);">
                            <span style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); color: #FF7A60; font-size: 16px; font-weight: 600; pointer-events: none; user-select: none;">@</span>
                            @error('email')
                        ...
                        <div style="position: relative; margin-bottom: 16px;">
                            <input id="password" type="password" name="password" placeholder="Password" required style="width: 100%; padding: 13px 40px 13px 16px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px; outline: none; color: #1e293b; background: #f8fafc; font-family: inherit; transition: border-color 0.2s ease;">
                            <button type="button" onclick="togglePasswordVisibility()" style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); background: none; border: none; color: #94a3b8; cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 0;">
                        ...
                        <button type="submit" style="width: 100%; padding: 13px; background: #FF7A60; color: #ffffff; border: none; border-radius: 10px; font-size: 15px; font-weight: 600; cursor: pointer; transition: background 0.2s ease; margin-bottom: 12px; font-family: inherit; box-shadow: 0 4px 12px rgba(255, 122, 96, 0.15);">
                            Login
                        </button>

                        <!-- Google Sign In Button -->
                        <button type="button" style="width: 100%; padding: 13px; background: #ffffff; color: #64748b; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px; font-weight: 600; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px; transition: background 0.2s ease; margin-bottom: 24px; font-family: inherit;">
    ...
    <script>
        ...
        // JS to toggle active styles for role selector
