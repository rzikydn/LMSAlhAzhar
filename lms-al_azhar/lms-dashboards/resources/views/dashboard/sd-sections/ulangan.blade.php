...
<div class="sd-content sd-content-ulangan">
  <div class="content-header"><h1>Ulangan <span>SDIT {{ setting('school_name') }}</span></h1><div class="header-right"><div class="avatar teal">{{ strtoupper(substr($siswa->nama, 0, 1)) }}</div></div></div>
